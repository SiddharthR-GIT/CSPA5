...
public class AddressBook extends JFrame {
    ...
    public static void main( String args[] )
    {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    String lnfDesign = "com.sun.java.swing.plaf.motif.MotifLookAndFeel";
                    UIManager.setLookAndFeel(lnfDesign);
                    new AddressBook();
                }
                catch (Exception e){
                    e.printStackTrace();
    ...
    private class NewAction extends AbstractAction {
        ...
        public void actionPerformed( ActionEvent e )
        {
            ...
            // display window
            entryFrame.setSize(new Dimension(400, 500));
    ...
    private class SaveAction extends AbstractAction {
        ...
        public void actionPerformed( ActionEvent e )
        {
            ...
            boolean validEir = false;
            validEir = validEIRCODE(person.getEircode());
            if(validEir) {
    ...
    private class SearchAction extends AbstractAction {
        ...
        public void actionPerformed( ActionEvent e )
        {
            ...
            if ( lastName != null ) {
                ...
                ArrayList<AddressBookEntry> personList = database.findPerson(lastName);

                for(int listSize=0; listSize<personList.size(); listSize++){

                    if ( personList != null ) {
                        AddressBookEntry findPerson = personList.get(listSize);
                        ...
                        entryFrame.setAddressBookEntry( findPerson );
                        // display window
                        entryFrame.setSize(new Dimension(400,500));
                        desktop.add( entryFrame );
                        entryFrame.setVisible( true );
                        ...
                        JOptionPane.showMessageDialog( desktop, "Entry with last name \"" + lastName +
