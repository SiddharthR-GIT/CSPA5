...
public class CloudscapeDataAccess
    ...
    public CloudscapeDataAccess() throws Exception
    {
        ...
        sqlFind = connection.prepareStatement(
                "SELECT personnames.personID, firstName, lastName, " +
                        "addressID, address1, address2, county, eircode, " +
                        "extraAddress1, extraAddress2, extraCounty, extraEircode, " +
                        "phoneID, phoneNumber, extraPhoneNumber, " +
                        "emailID, emailAddress, extraEmailAddress FROM personnames, addresses, phoneNumbers, emailAddresses " +
                        "WHERE lastName = ? AND " +
                        "personnames.personID = addresses.personID AND " +
                        "personnames.personID = phoneNumbers.personID AND " +
                        "personnames.personID = emailAddresses.personID" );


        // Obtain personID for last person inserted in database.
        // [This is a Cloudscape-spe
       ...
       // sqlPersonID = connection.prepareStatement("SELECT last_insert_id()");
        sqlPersonID = connection.prepareStatement("SELECT MAX(personID) FROM personnames");
        sqlInsertName = connection.prepareStatement(
                "INSERT INTO personnames ( firstName, lastName ) " +
                        "VALUES ( ? , ? )" );

        // insert address in table addresses
        sqlInsertAddress = connection.prepareStatement(
                "INSERT INTO addresses ( personID, " +
                        "address1, address2, county, eircode, extraAddress1, extraAddress2, extraCounty, extraEircode ) " +
                        "VALUES ( ? , ? , ? , ? , ? , ? , ? , ? , ? )");
        ...
        sqlUpdateName = connection.prepareStatement(
                "UPDATE personnames SET firstName = ?, lastName = ? " +
                        "WHERE personID = ?" );

        // update address in table addresses
        sqlUpdateAddress = connection.prepareStatement(
                "UPDATE addresses SET address1 = ?, address2 = ?, county = ?, eircode = ?," +
                        " extraAddress1 = ?, extraAddress2 = ?, extraCounty = ?, extraEircode = ? " +
                        "WHERE addressID = ?" );
        ...
        sqlDeleteName = connection.prepareStatement(
                "DELETE FROM personnames WHERE personID = ?" );
    ...
    private void connect() throws Exception
    {
        ...
        String url = "jdbc:mysql://localhost:3306/adBook?autoReconnect=true&useSSL=false";
    ...
    public ArrayList<AddressBookEntry> findPerson( String lastName )
    {
        try {
            ...
            ArrayList<AddressBookEntry> personList = new ArrayList<>();
            ...
            while (resultSet.next() ) {
                ...
                person.setCounty(resultSet.getString(7));
                person.setEircode(resultSet.getString(8));

                person.setExtraAddress1(resultSet.getString(9));
                person.setExtraAddress2(resultSet.getString(10));
                person.setExtraCounty(resultSet.getString(11));
                person.setExtraEircode(resultSet.getString(12));
            ...
            throws DataAccessException
    {
        ...
        try {
            ...
            sqlUpdateAddress.setString( 2, person.getAddress1() );
            sqlUpdateAddress.setString( 3, person.getAddress2() );
            sqlUpdateAddress.setString( 4, person.getCounty() );
            sqlUpdateAddress.setString( 5, person.getEircode() );
            sqlUpdateAddress.setString( 6, person.getExtraAddress1() );
            sqlUpdateAddress.setString( 7, person.getExtraAddress2() );
            sqlUpdateAddress.setString( 8, person.getExtraCounty() );
            sqlUpdateAddress.setString( 9, person.getExtraEircode() );
            sqlUpdateAddress.setInt( 1, person.getAddressID() );
            ...
            throws DataAccessException
    {
        ...
        try {
            ...
            if ( resultPersonID.next() ) {
                ...
                sqlInsertAddress.setString( 4, person.getCounty() );
                sqlInsertAddress.setString( 5, person.getEircode() );
                sqlInsertAddress.setString( 6, person.getExtraAddress1());
                sqlInsertAddress.setString( 7, person.getExtraAddress2());
                sqlInsertAddress.setString( 8, person.getExtraCounty());
                sqlInsertAddress.setString( 9, person.getExtraEircode());
